...
class controladorUsuarios {
  ...
  public function insertarUsuario($usuario) {
    ...
    $v = ($id > 0);
    $respuesta = new respuesta($v ? EMensajes::INSERCION_EXITOSA : EMensajes::ERROR);
  ...
  public function listarUsuarios() {
    ...
    $v = (count($lista) > 0);
    $respuesta = new respuesta($v ? EMensajes::CONSULTA_EXITOSA : EMensajes::ERROR);
  ...
  public function actualizarUsuario($usuario) {
    ...
    $v = ($actualizados > 0);
    $respuesta = new respuesta($v ? EMensajes::ACTUALIZACION_EXITOSA : EMensajes::ERROR);
  ...
  public function eliminarUsuario($idUsuario) {
    ...
    $v = ($eliminados > 0);
    $respuesta = new respuesta($v ? EMensajes::ELIMINACION_EXITOSA : EMensajes::ERROR);
